...
public abstract class UseFulMethods
{
	...
	static public void sendEmail(String d_email, String pwd, String m_to, String m_subject, String message) throws Exception
	{
	...
	static public Map<String, String> getProperties(String filePath ) throws IOException{
        ...
        InputStream inputStream = new Object() { }.getClass().getClassLoader().getResourceAsStream(filePath);
