...
{
	public void process(HashMap<String, String[]> context, Database db, String factID, List<List<LookupPair>> oldContextStr)
			throws Exception
	{
		if(!(context.containsKey("Assigned")))
		{
			...
			{	
				...
				db.putFactProcess(oldFactUpdate, db);
				db.putFactProcess(newFactInsert, db);
			}	
		}
    }
