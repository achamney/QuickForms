...
public class DispatcherToRuleEngine
{
	...
	public void dispatchToRuleEngine(Map<String, String[]> params, DataSource ds,String factID, List<List<LookupPair>> oldContext)
			throws Exception
	{
		...
		String stateHandler = "quickforms.sme." + appPackage + "."
		...
		Method method = theClass.getDeclaredMethod(methodName,params.getClass(),DataSource.class,String.class,List.class) ;
		method.invoke(appRulesClassObj, params, ds, factID,oldContext);
		
	}
	/*
	 public void dispatchToRuleEngine(Map<String,String[]> params, String factId, DataSource ds) 
	 throws Exception
	 {
	 ...
	 Class theClass = Class.forName(stateHandler); // reflection
	 AppInterface FhI = (AppInterface)theClass.newInstance();
	...
	/*
	 public void dispatchToRuleEngine(HttpServletRequest request,HttpServletResponse response, String factId, DataSource ds) 
	 throws Exception
	 {
		   
	 String appPackage=request.getParameter("app");
	 String appRuleEngine=(Character.toString(appPackage.charAt(0)).toUpperCase()+appPackage.substring(1));
