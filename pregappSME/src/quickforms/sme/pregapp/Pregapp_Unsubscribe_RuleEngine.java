 ...
 */
public class Pregapp_Unsubscribe_RuleEngine
{
	public void process(HashMap<String, String[]> context, DataSource ds,String factID, List<List<LookupPair>> oldContextStr) throws Exception
	{
			...
			
		{
			...
			String lkup_UsersJSon = db.getResultSet(context.get("app")[0], "getUserDetails", null, whereClause);
	...
	public String  sendEmailProcess(HashMap<String, String[]> context,String subject,String msg)
	...
	public Map<String, String[]> setOldContext(HashMap<String, String[]> context, String DueDate,String factID,String UserTabelKey ) throws Exception
	{
